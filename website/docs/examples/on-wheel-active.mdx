...
Visit the [source code](https://github.com/KurtGokhan/react-on/blob/main/website/src/examples/onwheel-active.tsx) of this example to see the full implementation.
