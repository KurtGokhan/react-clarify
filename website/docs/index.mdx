...
To use JSX Middlewares, you need to setup your JSX transpiler to use the `react-on/react` package as the JSX factory. This is done differently depending on the transpiler you are using.
...
{
  "compilerOptions": {
    "jsxImportSource": "react-on/react"
  }
}
```
...
```jsx title="main.jsx"
import { addMiddlewares } from 'react-on/react';
